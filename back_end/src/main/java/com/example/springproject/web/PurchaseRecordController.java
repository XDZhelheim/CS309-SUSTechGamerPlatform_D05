...
public class PurchaseRecordController {
    ...
    public String saveNew(PurchaseRecord purchaseRecord, RedirectAttributes attributes){
    ...
    public String deletePurchaseRecord(@PathVariable long id,RedirectAttributes attributes){
